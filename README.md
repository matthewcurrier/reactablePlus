...
declarative `row_spec`, `col_spec`, and `table_config` objects. The module
handles rendering, input collection, validation, selection gating, reset,
and data marshaling without any domain-specific knowledge.
